...
public class ZenScriptImportStatementImpl extends ASTWrapperPsiElement implements ZenScriptImportStatement {

  public ZenScriptImportStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ZenScriptImportStr getImportStr() {
    return findNotNullChildByClass(ZenScriptImportStr.class);
  }
