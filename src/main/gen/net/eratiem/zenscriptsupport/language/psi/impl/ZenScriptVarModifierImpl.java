...
public class ZenScriptVarModifierImpl extends ASTWrapperPsiElement implements ZenScriptVarModifier {

  public ZenScriptVarModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
