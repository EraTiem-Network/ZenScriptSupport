...
public class ZenScriptOreLiquidEntryImpl extends ASTWrapperPsiElement implements ZenScriptOreLiquidEntry {

  public ZenScriptOreLiquidEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZenScriptVisitor visitor) {
    visitor.visitOreLiquidEntry(this);
  }
